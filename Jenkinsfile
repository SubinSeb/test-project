pipeline {
  ...
  stages {
    ...
    stage('Push result image') {
      steps {
        withDockerRegistry(credentialsId: '2d946ebb-4b0c-4a32-8756-f115273f9f61', url:'https://10.1.1.6:443/dockersamples') {
          sh 'echo ${26418bc0-b2e4-4a07-9ef1-3643a5289b0e} | sudo -S docker push 10.1.1.6:443/dockersamples/result:latest --disable-content-trust=0'
        }
      }
    }
    stage('Push vote image') {
      steps {
        withDockerRegistry(credentialsId: '2d946ebb-4b0c-4a32-8756-f115273f9f61', url:'https://10.1.1.6:443/dockersamples') {
          sh 'echo ${26418bc0-b2e4-4a07-9ef1-3643a5289b0e} | sudo -S docker push 10.1.1.6:443/dockersamples/vote:latest --disable-content-trust=0'
        }
      }
    }
    stage('Push worker image') {
      steps {
        withDockerRegistry(credentialsId: '2d946ebb-4b0c-4a32-8756-f115273f9f61', url:'https://10.1.1.6:443/dockersamples') {
          sh 'echo ${26418bc0-b2e4-4a07-9ef1-3643a5289b0e} | sudo -S docker push 10.1.1.6:443/dockersamples/worker:latest --disable-content-trust=0'
        }
      }
    }
  }
